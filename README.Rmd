...
The package strives to modify as little of the file as possible on import, however it does ensure some values are in upper/lower case in line with the GEDCOM specification and to ensure the correct functioning of `gedcompendium` packages.
